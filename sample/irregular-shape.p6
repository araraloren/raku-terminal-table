...
my &hide = -> $x, $y {
    ...
    my $top = $rx == 0 || $g.is-hide($rx - 1, $ry + 1);
    my $top-left = ($rx == 0 || $ry == 0) || $g.is-hide($rx - 1, $ry - 1);
    my $top-right = ($rx == 0 || $ry + 2 == $c) || $g.is-hide($rx - 1, $ry + 3);
    my $bottom = ($rx + 2 == $r) || $g.is-hide($rx + 3, $ry + 1);
    my $bottom-left = ($rx + 2 == $r || $ry == 0) || $g.is-hide($rx + 3, $ry - 1);
    my $bottom-right = ($rx + 2 == $r || $ry + 2 == $c) || $g.is-hide($rx + 3, $ry + 3);
    my $left = $ry == 0 || $g.is-hide($rx + 1, $ry - 1);
    my $right = ($ry + 2 == $c) || $g.is-hide($rx + 1, $ry + 3);
